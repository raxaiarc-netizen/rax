...
Thanks for your interest in contributing! Rax is a desktop overlay for Claude Code, and we welcome bug reports, feature ideas, and pull requests.
...
2. Fork and clone the repo:
   ```bash
   git clone https://github.com/<your-username>/rax.git
   cd rax
   ```
...
- Set `RAX_DEBUG=1` to enable verbose main-process logging to `~/.rax-debug.log`.
