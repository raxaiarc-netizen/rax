        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: colors.textTertiary, marginTop: 2 }}>
              Install skills and plugins without leaving RAX
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          {showConfirm && status === 'not_installed' && (
            <div style={{
              ...
              <div style={{
                fontSize: 10, fontFamily: "'Poppins', -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', system-ui, sans-serif", color: colors.textSecondary,
